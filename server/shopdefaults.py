...
#:
#: ★ 难度分四档，锚点是用户 2026-09-13 定的
#:   **`560004 [幸运幸存者]` = 500 张 + 100000 金币**（它是全表最强的一个：
...
TITLE = {
    # ---- A 最强：50% 概率完全免伤 ----
    560004: (100000, ((60004, 500),)),          # [幸运幸存者] ← 幸运卡片
    # ---- B 强 ----
    560005: (30000, ((60005, 120),)),           # [手下留情] 伤害翻倍（45 点额度）
    560006: (30000, ((60006, 120),)),           # [红心达人] 捡心 15% 全队回血
    610001: (40000, ((110001, 100),)),          # [左轮手枪高手] 本系攻击 +15%
    620001: (40000, ((120001, 100),)),          # [复古短枪高手] +15%
    630001: (40000, ((130001, 100),)),          # [重机枪高手] +15%
    # ---- C 中 ----
    610002: (20000, ((110002, 60),)),           # [苹果弹高手] +5%
    620002: (20000, ((120002, 60),)),           # [火焰弹高手] +5%
    630002: (20000, ((130002, 60),)),           # [榴弹发射器高手] +5%
    610003: (15000, ((110003, 40),)),           # [狙击枪高手] +3%
    620003: (15000, ((120003, 40),)),           # [华尔兹加农炮高手] +3%
    630003: (15000, ((130003, 40),)),           # [火箭炮高手] +3%
    # ---- D 弱 / 纯荣誉 ----
    #   ★ `560001` 的加成是「攻击 +5、生命 **−10%**」—— 净收益很可能是负的，
    #     所以它便宜，贵的是那张卡本身（零死亡获胜才给一张）。
    560001: (5000, ((60001, 30),)),             # [完美胜利者]
    560002: (5000, ((60002, 30),)),             # [格斗达人] ⚠ 加成不会触发，见上
    560003: (5000, ((60003, 30),)),             # [射击达人] 生存 / 夺分防御 +2
    560007: (3000, ((60007, 20),)),             # [队内间谍] 对队友伤害 −5%
